...
return [
    ...
    'submitters' => [
        'sns' => ['name' => 'Srpska napredna stranka sa koalicionim partnerima (SDPS, PUPS, PS, SNP, PSS)', 'short_name' => 'SNS', 'type' => 'coalition', 'is_minority' => false, 'color' => '#1f4e9c'],
        'sps' => ['name' => 'Socijalistička partija Srbije – Jedinstvena Srbija – Zeleni Srbije', 'short_name' => 'SPS–JS', 'type' => 'coalition', 'is_minority' => false, 'color' => '#d7192d'],
        'spn' => ['name' => 'Koalicija Srbija protiv nasilja (SSP, NPS, ZLF, DS, PSG, SRCE, Ekološki ustanak, Zajedno)', 'short_name' => 'SPN', 'type' => 'coalition', 'is_minority' => false, 'color' => '#6a1b9a'],
        'srs' => ['name' => 'Srpska radikalna stranka', 'short_name' => 'SRS', 'type' => 'party', 'is_minority' => false, 'color' => '#0d2b5e'],
        'nada' => ['name' => 'Koalicija NADA (Nova demokratska stranka Srbije, Pokret obnove Kraljevine Srbije)', 'short_name' => 'NADA', 'type' => 'coalition', 'is_minority' => false, 'color' => '#c99a2e'],
        'svm' => ['name' => 'Savez vojvođanskih Mađara (Vajdasági Magyar Szövetség)', 'short_name' => 'SVM', 'type' => 'party', 'is_minority' => true, 'color' => '#2e8b57'],
        'ns' => ['name' => 'Narodna stranka', 'short_name' => 'NS', 'type' => 'party', 'is_minority' => false, 'color' => '#1e88e5'],
        'mi' => ['name' => 'Grupa građana „Mi – glas iz naroda“', 'short_name' => 'MI–GIN', 'type' => 'citizen_group', 'is_minority' => false, 'color' => '#ef6c00'],
        'no' => ['name' => 'Koalicija Nacionalno okupljanje (Srpski pokret Dveri, Srpska stranka Zavetnici)', 'short_name' => 'NO', 'type' => 'coalition', 'is_minority' => false, 'color' => '#8b0000'],
        'sda' => ['name' => 'Stranka demokratske akcije Sandžaka', 'short_name' => 'SDA', 'type' => 'party', 'is_minority' => true, 'color' => '#006400'],
        'spp' => ['name' => 'Stranka pravde i pomirenja', 'short_name' => 'SPP', 'type' => 'party', 'is_minority' => true, 'color' => '#00a651'],
        'zzv' => ['name' => 'Koalicija Zajedno za Vojvodinu – Vojvođani', 'short_name' => 'ZZV', 'type' => 'coalition', 'is_minority' => true, 'color' => '#f2c200'],
        'kad' => ['name' => 'Koalicija Albanaca Preševske doline', 'short_name' => 'KAD', 'type' => 'coalition', 'is_minority' => true, 'color' => '#b71c1c'],
        'rus' => ['name' => 'Ruska stranka', 'short_name' => 'RUS', 'type' => 'party', 'is_minority' => true, 'color' => '#795548'],
    ],
